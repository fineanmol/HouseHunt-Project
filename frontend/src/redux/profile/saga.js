...
export function* watchGetContact() {
  yield takeEvery(PROFILE_GET_CONTACTS, loadContacts);
}

export function* watchGetConversation() {
  yield takeEvery(PROFILE_GET_CONVERSATIONS, loadConversations);
}

export function* watchAddMessageToConversation() {
  yield takeEvery(PROFILE_ADD_MESSAGE_TO_CONVERSATION, addMessageToConversation);
}

export function* watchCreateConversation() {
  yield takeEvery(PROFILE_CREATE_CONVERSATION, createNewConversation);
}
