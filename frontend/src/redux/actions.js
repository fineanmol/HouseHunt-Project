...
/* CHAT APP */
export const PROFILE_GET_CONTACTS = 'PROFILE_GET_CONTACTS';
export const PROFILE_GET_CONTACTS_SUCCESS = 'PROFILE_GET_CONTACTS_SUCCESS';
export const PROFILE_GET_CONTACTS_ERROR = 'PROFILE_GET_CONTACTS_ERROR';
export const PROFILE_GET_CONVERSATIONS = 'PROFILE_GET_CONVERSATIONS';
export const PROFILE_GET_CONVERSATIONS_SUCCESS = 'PROFILE_GET_CONVERSATIONS_SUCCESS';
export const PROFILE_GET_CONVERSATIONS_ERROR = 'PROFILE_GET_CONVERSATIONS_ERROR';
export const PROFILE_ADD_MESSAGE_TO_CONVERSATION =
  'PROFILE_ADD_MESSAGE_TO_CONVERSATION';
export const PROFILE_CREATE_CONVERSATION = 'PROFILE_CREATE_CONVERSATION';
export const PROFILE_SEARCH_CONTACT = 'PROFILE_SEARCH_CONTACT';
export const PROFILE_CHANGE_CONVERSATION = 'PROFILE_CHANGE_CONVERSATION';
